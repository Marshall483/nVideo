...
namespace Services
{
    public class ShopCart
    {
        ...
        private ShopCart(Database db, HttpContext httpContext)
        {
            _db = db;
        ...
        public static ShopCart GetCart(IServiceProvider service)
        {
            ...
            var context = service.GetService<Database>();           
        ...
        private static List<ShopCartItem> GetCartItemFromCookie(string userInfo, string cartInfo, Database context)
        {
            if (cartInfo == null)
                return null;
        ...
        private static void AddToCartRange(Database context, string userName, IEnumerable<ShopCartItem> items)
        {
        ...
        private static void AddToCart(Database context, string userName, int id, uint quanity)
        {
        ...
        public async Task FlushAsync(User user) {
            var items = _db.ShopCartItems.Where(
        ...
        public IEnumerable<ShopCartItem> GetShopItems()
        {
            ...
            else
            {
                ...
                return GetCartItemFromCookie("anon", cartInfo, _db);
            }
        }
    }
}
